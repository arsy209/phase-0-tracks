...
#gives the player a set amount of turns to guess before the game ends.
  ...
  until turn_counter == 10
      puts "You have #{turns} turns to guess the word.You would need to guess the letters before the your given turns are over. If you completed the given space and know the word you typed is correct, you can type Guess to type the word."
